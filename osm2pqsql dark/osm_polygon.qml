...
<qgis version="2.4.0-Chugiak" minimumScale="-4.65661e-10" maximumScale="40000" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule symbol="0" label="default"/>
      <rule filter="&quot;landuse&quot;  in ( 'grass' , 'garden', 'allotments' , 'park', 'cemetery', 'farm' , 'farmland' , 'farmyard' , 'field' , 'forest' , 'meadow', 'orchard' , 'plant_nursery' , 'recreation_ground' , 'tree nursery' , 'village_green'    ) or  &quot;leisure&quot; in ( 'common' , 'garden' , 'park' , 'pitch' , 'golf_course' , 'walled garden' )" symbol="1" label="grass"/>
      <rule filter=" &quot;building&quot;  IS NOT NULL or &quot;historic&quot; is not null" symbol="2" label="building"/>
      <rule filter=" &quot;water&quot; is not NULL or  &quot;waterway&quot; is not null  or &quot;landuse&quot;  = 'pond' or  &quot;natural&quot; = 'water' " symbol="3" label="water"/>
      <rule filter=" &quot;highway&quot;  in ( 'footway' , 'path' , 'pedestrian' , 'residential', 'unclassified' )" symbol="4" label="pedestrian"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.682353" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="border_width_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="building"/>
